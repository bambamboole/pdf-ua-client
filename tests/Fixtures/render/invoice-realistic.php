    ...
    spec: [
        ...
        'rows' => [
            ...
            [
                'columnWidths' => ['60%', '40%'],
                'blocks' => [
                    ['type' => 'text', 'props' => ['text' => "Muster GmbH\n\nBeispielstraße 1\n\n10115 Berlin"]],
            ...
            ['blocks' => [
                [
                    'type' => 'text',
                    'props' => ['text' => 'Please transfer the total amount within 30 days to the bank account stated above. Thank you for your business.'],
